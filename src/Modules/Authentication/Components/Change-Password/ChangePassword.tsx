                    ...
                    <div className="col-md-5 d-flex flex-column align-items-center">
                        ...
                        >
                            <div className="title mb-5">
                                ...
                                <h4><span style={{ textDecoration: "underline" }}>C</span>hange Password</h4>
                            </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                {errors.confirmNewPassword && <div className='mb-2 text-danger'>{errors.confirmNewPassword.message}</div>}

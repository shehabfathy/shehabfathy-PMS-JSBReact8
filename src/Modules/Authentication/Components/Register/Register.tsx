         ...
         <div className="col-md-9 d-flex flex-column align-items-center">
          ...
          <div  className="p-4 form-container rounded-4 w-100 auth-form">
            ...
            <div className="title  text-start">
              ...
              <h4 ><span style={{ textDecoration: "underline" }}>C</span>reate New Account</h4>
            </div>
                ...
                <div className="col-md-6">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="input-group">
                      ...
                      >
                        <i className={showPassword.password ? "fa-solid fa-eye" : "fa-solid fa-eye-slash"}></i>
                      </button>
                    </div>
                    {errors.password && (
                      <p className="text-danger small ">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="input-group">
                      ...
                      <button
                        ...
                        style={{ cursor: "pointer" }}
                      >
                        <i className={showPassword.confirm ? "fa-solid fa-eye" : "fa-solid fa-eye-slash"}></i>
                      </button>
                    </div>

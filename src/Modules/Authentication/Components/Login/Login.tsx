...
import { emailValidation, PASSWORD_VALIDATION } from "../../../Shared-Components/Components/utils/formValidation";
          ...
          <div className="col-md-5 d-flex flex-column align-items-center">
            ...
            >
              <div className="title mb-5">
                ...
                <h4><span style={{ textDecoration: "underline" }}>L</span>ogin</h4>
              </div>
